...
(async () => {
  ...
  const q = await sc.quoteSend(
    {
      ...
      extraOptions: "0x0003010011010000000000000000000000000016e360",
  ...
  //   {
  //     dstEid: 40245,
  //     to: "0x000000000000000000000000db61c4d439418b4343a5497b0c460afc69c8543c",
  //     amountLD: BigInt(1e19),
  //     minAmountLD: BigInt(9e18),
  //     extraOptions: "0x0003010011010000000000000000000000000016e360",
  //     composeMsg: "0x00000000000000000000000077d7703056602b548cae408ac33e7775a22d9ede0000000000000000000000000000000000000000000000008ac7230489e80000",
  ...
  // const en = await sc.setEnforcedOptions([{eid: BigInt(40161),msgType: BigInt(2), options:"0x0003010011010000000000000000000000000016e360"}])
  // await en.wait();
  // console.log(en);
  ...
  const s = await sc.send(
    ...
    "0x77D7703056602B548CaE408aC33e7775A22D9eDe",
    { value: BigInt(1e17) }
  );
  await s.wait();
  console.log(s);
